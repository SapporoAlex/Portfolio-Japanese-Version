...
languageBtn.addEventListener('click', () => {
    if (currentLanguage === "Japanese") {
        ...
        project3Date.textContent = "Made for hotel company"
        ...
        aboutText.textContent = "北海道札幌市在住のプログラマーです。現在、日本企業のワークフローを改善し、ステークホルダーに最新の洞察を提供するために使用されている多くのプロジェクトを完了しました。自動化、ウェブスクレイピング、データ分析、ウェブ開発、家庭教師などのITソリューションを企業と一緒に探しています。日本語と英語が話せます。より良い意思決定をするために必要なデータを入手したり、ワークフローを改善するためのソフトウェアを構築したり、ウェブサイトを作ったり変更したり、プログラミングを教えたりする人をお探しでしたら、私にお任せください。"
        ...
        project3Date.textContent = "ホテル会社向けに作られました"
